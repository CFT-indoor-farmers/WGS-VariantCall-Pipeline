...
GENOTYPE_DIR="/path/for/PLINK/ESativa/output_files"
...
# Additionally, perform P and Q matrix calculation for K=2 to K=7 example.
for K in {2..7}; do
    $ADMIXTURE_BIN --cv "$GENOTYPE_DIR/Merged_ErucaSativa_SNPs_geno_maf005_LDprune_final.bed" $K -j4 | tee log${K}.out 
done